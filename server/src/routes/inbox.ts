...
// Parse a YYYY-MM-DD string as midnight in local time, not UTC. Fixes the
// off-by-one in Pacific timezones.
...
// ─── source 3: Zoom transcript summaries ──────────────────────────────────
// Reads ONLY *_summary.md files (the AI-generated digest the auto-sync
// produces). Raw transcripts stay in the vault; only the summary is the
// inbox notification.
