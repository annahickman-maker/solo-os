...
Emotion in copy is about **recognition**, not **manipulation**. You name what the reader is already feeling so they feel seen. You do not plant emotion they aren't already carrying.

The test: would the reader read your sentence and think "yes, that's me" or "ugh, this is trying too hard"? If trying-too-hard, soften.

## Where emotion belongs
...
Never:
- Invent shared experience the reader doesn't have ("we've all been there" when they haven't)
- Push false urgency ("you'll regret this forever if you don't act")
- Use guilt as a lever ("you owe it to yourself / your family")
- Manufacture stakes that don't exist (no fake "deadline" or "last chance")
- Lean on tragedy or fear-based identity attacks ("you'll always be stuck if...")

If a line makes the reader feel pushed, it's manipulation. If it makes them feel seen, it's good copy.

## Writing process

1. Read `core_audience.md` for what the reader is actually carrying
2. Read `core_voice-style.md` for the user's emotional register
3. For each section, ask: what emotion belongs here? (Recognition / relief / hope / warmth / none)
4. Write the line. Apply the "yes that's me / ugh trying too hard" test.
5. Strip any line that pushes instead of names

## Common failure modes

- Emotional language in logistics sections (kills the build)
- Naming feelings instead of situations ("you feel overwhelmed" vs "you're staring at the email at 11pm")
- Forced empathy ("we've all been there") when the reader hasn't
- Heavy-handed relief language that sounds like a guru
- Using fear/guilt to push action
